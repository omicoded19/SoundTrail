        ...
        <section className="overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.055] shadow-2xl shadow-black/40 backdrop-blur-2xl">
          <div className="border-b border-white/10 px-6 py-7 sm:px-8">
            ...
            <p className="mt-2 text-sm leading-6 text-white/45">
              ...
              your music trail across devices.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="h-13 w-full rounded-2xl border border-white/10 bg-black/20 py-3 pl-12 pr-4 text-white outline-none transition placeholder:text-white/25 focus:border-[var(--accent)] focus:ring-4 focus:ring-[var(--accent-soft)]"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative mt-2">
                ...
                <input
                  ...
                  className="h-13 w-full rounded-2xl border border-white/10 bg-black/20 py-3 pl-12 pr-12 text-white outline-none transition placeholder:text-white/25 focus:border-[var(--accent)] focus:ring-4 focus:ring-[var(--accent-soft)]"
                />
